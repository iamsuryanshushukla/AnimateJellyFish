package com.example.jellyfish.ui.theme
...
import com.example.jellyfish.ui.theme.JellyFishPaths.bubble1
import com.example.jellyfish.ui.theme.JellyFishPaths.bubble1Dp
import com.example.jellyfish.ui.theme.JellyFishPaths.bubble2
import com.example.jellyfish.ui.theme.JellyFishPaths.bubble3
import com.example.jellyfish.ui.theme.JellyFishPaths.bubble4
import com.example.jellyfish.ui.theme.JellyFishPaths.bubble5
import com.example.jellyfish.ui.theme.JellyFishPaths.bubble5dp
import com.example.jellyfish.ui.theme.JellyFishPaths.face
import com.example.jellyfish.ui.theme.JellyFishPaths.freckle1
import com.example.jellyfish.ui.theme.JellyFishPaths.freckle2
import com.example.jellyfish.ui.theme.JellyFishPaths.freckle3
import com.example.jellyfish.ui.theme.JellyFishPaths.freckle4
import com.example.jellyfish.ui.theme.JellyFishPaths.leftEye
import com.example.jellyfish.ui.theme.JellyFishPaths.mouth
import com.example.jellyfish.ui.theme.JellyFishPaths.outerJelly
import com.example.jellyfish.ui.theme.JellyFishPaths.rightEye
import com.example.jellyfish.ui.theme.JellyFishPaths.tentacle2
import com.example.jellyfish.ui.theme.JellyFishPaths.tentacle3
import com.example.jellyfish.ui.theme.JellyFishPaths.tentacle4
import com.example.jellyfish.ui.theme.JellyFishPaths.tentacle5
import com.example.jellyfish.ui.theme.JellyFishPaths.tentacle6
import com.example.jellyfish.ui.theme.JellyFishPaths.tentacle7
import com.example.jellyfish.ui.theme.JellyFishPaths.tentacle8
import com.example.jellyfish.ui.theme.JellyFishPaths.tentacle9
import com.example.jellyfish.ui.theme.JellyFishPaths.tentaclePath
import com.example.jellyfish.ui.theme.JellyFishPaths.tentaclefinal
import kotlinx.coroutines.coroutineScope
import kotlinx.coroutines.launch
import org.intellij.lang.annotations.Language

val solidWhite = SolidColor(Color.White)
val solid = SolidColor(Color.Black)
...
fun JellyfishAnimation() {
    ...
    val vectorPainterFace = rememberVectorPainter(
        ...
        val translationYBubbles by transition.animateFloat(
            initialValue = 0f,
            targetValue = -50f,
            animationSpec = infiniteRepeatable(
                tween(duration , easing = EaseInOut),
    ...
    val vectorPainter = rememberVectorPainter(
        defaultWidth = 680.46f.dp,
        defaultHeight = 863.1f.dp,
        viewportHeight = 563.1f,
        viewportWidth = 530.46f,
    ) { _, _ ->
        val duration = 3000
        ...
        Group(name = "bubbles", translationX = translationY) {
            Path(
                bubble1,
                fill = solidWhite,
                fillAlpha = 0.67f
        ...
        Group(name = "bubbles", translationY = translationY) {
            Path(
                bubble1Dp,
                fill = solidWhite,
                fillAlpha = 0.67f
        ...
        Group(name = "bubbles2", translationY = translationY) {

            androidx.compose.ui.graphics.vector.Path(pathData = bubble2
                ,
                fill = solidWhite,
                fillAlpha = 0.75f)
...
object JellyFishPaths {
    ...
    val bubble1Dp = PathParser().parsePathString(
        """
                    M400.85 110.41c-7.37 4.94-6.92 18 4.34 16.82a19.89 19.89 0 0 0 3.34-.71c13.54-4.17 9.8-20.35-3.66-17.77a10.52 10.52 0 0 0-4.02 1.66z
                """.trimIndent()
    ).toNodes()
    ...
    val bubble4dp = PathParser().parsePathString(
        """
                    M420.89 100.46c1.65-4.09-3.5-9.45-8.22-5.07s1.65 10.47 6.36 7.28a4.87 4.87 0 0 0 1.86-2.21z
                """.trimIndent()
    ).toNodes()
    ...
    val bubble5dp = PathParser().parsePathString(
        """
                    M124 272.88c-2-.26-4.34 1.09-3.68 4.42 1.68 8.05 11.35-3.48 3.68-4.42z
                """.trimIndent()
    ).toNodes()
    val leftEye =
    ...
    val tentaclefinal = PathParser().parsePathString(
        "M235.85,247.72C198.75,294.75 352.45,374.39 280.9,444.77M294.15,258.98C319.49,294.85 198.46,365.92 235.85,402.55M212,247.72C151.05,284.32 270.3,349.06 198.75,377.21M320.65,253.35C304.75,264.61 299.45,298.39 307.4,301.2C315.35,304.02 305.83,355.05 275.6,365.95M333.9,247.72C366.15,279.5 288.85,343.43 344.5,374.39"
    ).toNodes()
    val tentacle2 =
